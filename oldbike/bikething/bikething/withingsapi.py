...
consumer_key = '651750d3699dc4c102bf4700db3fc2f7d548b6175f968bde3d2d72d819256'
consumer_secret = '0f20b9d5dc1bc3e566753f80fef691ee84e6799809d4491f15c790b5fb3e'
...
class WithingsClient(object):
    ...
    def __init__(self, oauth_token=None, oauth_token_secret=None, userid=None):
    ...
    def get_access_token(self, oauth_verifier):
        ...
        log.warn("context = %r", content)
        access_token = dict(urlparse.parse_qsl(content))
        log.warn('access_token = %r', access_token)
        if int(resp['status']) != 200 or 'oauth_token' not in access_token:
            raise Exception('Invalid oauth response from Withings (status=%r)' % resp['status'])
