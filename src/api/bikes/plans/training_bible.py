...
workouts = {
    ...
    'A1': ['Group Ride', 'Ride how you feel. If tired, sit in or break off and ride by yourweek. If fresh, ride hard going into the 5 zones several times.', ['Build 1', 'Build 2', 'Peak', 'Race']],
...
annual_hours_lookup = {
    ...
    'Build 1-4': [3.0, 3.5, 4.5, 5.0, 5.5, 6.5, 7.0, 8.0, 8.5, 9.0, 10.0, 10.5, 11.5, 12.0, 12.5, 13.5, 14.0, 15.0, 15.5, 16.0, 17.0],
    'Build 2':      [5.0, 6.0, 7.0, 8.5, 9.5, 10.5, 11.0, 13.0, 14.5, 15.5, 16.5, 18.0, 19.0, 20.5, 21.5, 22.5, 24.0, 25.0, 26.5, 27.0, 28.5],
    'Build 2-4': [3.0, 3.5, 4.5, 5.0, 5.5, 6.5, 7.0, 8.0, 8.5, 9.0, 10.0, 10.5, 11.5, 12.0, 12.5, 13.5, 14.0, 15.0, 15.5, 16.0, 17.0],
