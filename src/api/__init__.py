...
#
# from .calendar_api import Calendar  # type: ignore
# from .users_api import Users  # type: ignore
# from .utils import is_logged_in  # type: ignore
# from bikedb import heatmap, offroad, queries, stravaapi  # type: ignore
# from .training_api import api as training_api  # type: ignore
#
...
# )
# api = NinjaAPI(app)
# api.add_router(training_api, prefix="/training")
#
#
# CORS(
#     app,
...
#         hr = HttpResponse(
#             content=r.response, status=r.status, content_type=r.content_type
#         )
...
#         fn = offroad.find_offroad_segments(
#             strava_activity_id or 2347770699, do_graph=True
#         )
#         resp = HttpResponse(
...
#
# api_framework.app_class_proxy(app, "", "api/framework", api_framework.FrameworkApi())
#
#
# codes = [400, 406, 404]
#
